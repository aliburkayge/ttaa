...
export function ayVerificationLandingHtml() {
  return `${style}<main class="ayv"><header class="ayv-hero"><div class="ayv-hero-top"><div class="ayv-brand"><span>AY TERCÜME</span><strong>Belge güvenliği</strong></div></div><div class="ayv-hero-body"><span class="ayv-kicker">RESMÎ DOĞRULAMA ALANI</span><h1>Belge doğrulama</h1><p class="ayv-lead">AY Tercüme tarafından hazırlanan QR kodlu belgelerde kodu okutarak belgeye özel doğrulama sayfasını açabilirsiniz. Sayfada belge numarası, müşteri adı, tarih ve dosya gösterilir.</p></div></header>${contactSection()}</main>`;
}
...
export function ayVerificationDocumentHtml(document: AyVerificationDocument, marker: string) {
  ...
  return `${style}<main class="ayv"><header class="ayv-hero"><div class="ayv-hero-top"><span class="ayv-seal" aria-hidden="true"></span><div class="ayv-brand"><span>AY TERCÜME</span><strong>Belge doğrulama</strong></div><span class="ayv-verified">ONAYLI KAYIT</span></div><div class="ayv-hero-body"><span class="ayv-kicker">DOĞRULANMIŞ BELGE</span><h1>Bu dosya AY Tercüme tarafından oluşturulup doğrulanmıştır.</h1><p class="ayv-lead">${url ? "Aşağıdaki belge bilgilerini ve dosyanın kendisini inceleyebilirsiniz." : "Belge bilgileri aşağıdadır. Dosya hazır olduğunda bu sayfada görüntülenecektir."}</p></div><div class="ayv-hero-foot"><span class="ayv-status">Doğrulanmış belge</span><span class="ayv-hero-foot-note">AY Tercüme resmî belge kaydı</span></div></header>
