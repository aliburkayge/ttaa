...
const PROMPT = [
  ...
  "- stamp: an ink stamp or seal impression applied onto the page (rubber stamp, notary or company stamp, embossed seal), without a handwritten signature",
  "- signature_stamp: a handwritten signature and a stamp/seal together",
  "- logo: a company or institution logo, including an emblem or seal printed as part of the letterhead",
